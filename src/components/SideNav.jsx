        ...
        <div className="nav-content d-flex">
          ...
          <div className="menu-container flex-grow-1">
            <ul id="menu" className="menu">
              <li>
                <Link to="/">
                  <i data-acorn-icon="shop" className="icon" data-acorn-size="18"></i>
              ...
              <li>
                <Link to="#Admin" data-href="Admin.html">
                  <i data-acorn-icon="cart" className="icon" data-acorn-size="18"></i>
              ...
              <li>
                <Link to="#products" data-href="Products.html">
                  <i data-acorn-icon="cupcake" className="icon" data-acorn-size="18"></i>
                ...
                <ul id="products">
                  <li>
                    ...
                    {/* <Link to="/product-list"><span className="label">List</span></Link> */}
                  </li>
                  <li>
                    <Link to="/product">
              ...
              <li>
                <Link to="#customers" data-href="Customers.html">
                  <i data-acorn-icon="user" className="icon" data-acorn-size="18"></i>
                  <span className="label">Customers</span>
                </Link>
                <ul id="customers">
                  <li>
                    <Link to="Customers.List.html">
                      <span className="label">List</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="Customers.Detail.html">
                      <span className="label">Detail</span>
                    </Link>
                  </li>
                </ul>
              ...
              <li>
                <Link to="#storefront" data-href="Storefront.html">
                  <i data-acorn-icon="screen" className="icon" data-acorn-size="18"></i>
                  <span className="label">Sales</span>
                </Link>
                <ul id="storefront">
                  <li>
                    <Link to="Storefront.Home.html">
                      <span className="label">Home</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="Storefront.Filters.html">
                      <span className="label">Filters</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="Storefront.Categories.html">
                      <span className="label">Categories</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="Storefront.Detail.html">
                      <span className="label">Detail</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="Storefront.Cart.html">
                      <span className="label">Cart</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="Storefront.Checkout.html">
                      <span className="label">Checkout</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="Storefront.Invoice.html">
              ...
              <li>
                <Link to="Shipping.html">
                  <i data-acorn-icon="shipping" className="icon" data-acorn-size="18"></i>
                  <span className="label">Shipping</span>
                </Link>
              </li>
              <li>
                <Link to="Discount.html">
                  <i data-acorn-icon="tag" className="icon" data-acorn-size="18"></i>
                  <span className="label">Discount</span>
                </Link>
              </li>
              <li>
                <Link to="Settings.html">
                  <i data-acorn-icon="gear" className="icon" data-acorn-size="18"></i>
